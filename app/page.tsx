...
export default function Page({
  ...
  return (
    <div className="bg-indigo-500 h-screen w-screen flex flex-col items-center justify-center">
      ...
      <div className="w-[676px] flex flex-row items-center mt-10 justify-between">
        <span className={"w-40 text-white font-semibold text-left text-2xl"} >Letters</span>
        <span className={`w-40 font-semibold text-center text-2xl ${step >= 2 ? "text-white" : "text-gray-400"}`} >Words</span>
        <span className={`w-40 font-semibold text-right text-2xl translate-x-6 ${step >= 3 ? "text-white" : "text-gray-400"}`}>Sentences</span>
      </div>
